    ...
    return (
        <Wrapper>
            <div className="px-3 pt-3">
                <div className="row">
                    <div className="col">
                        <div className="p-2 text-light rounded bg-primary" style={{ fontSize: "18px" }}>Ma'muriy tuzilishi</div>
                    ...
                    <div className="col">
                        <div className="p-2 text-light rounded bg-primary" style={{ fontSize: "18px" }}>Shahar va tumanlar
                        </div>
